...
class VerifikatorDashboard extends StatelessWidget {
  ...
  const VerifikatorDashboard({super.key, required this.user, this.data});
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            'Verifikasi usulan KAK yang baru masuk',
      ...
      child: Row(
        children: [
          ...
          Container(
            ...
            child: const Icon(Icons.rule, color: Colors.white, size: 48),
          ),
        ],
      ),
    );
      ...
      builder: (context, constraints) {
        return GridView.count(
          ...
          children: [
            ...
            _buildStatCard(Icons.check_circle_outline, '${stats?.disetujui ?? 0}', 'TERVERIFIKASI', AppTheme.disetujuiGradient),
