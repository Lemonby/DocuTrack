                ...
                <div class="px-6 pb-6">
                    ...
                    <div class="mt-14 text-center">
                        ...
                        <div class="mt-4 flex items-center justify-center gap-2 px-3 py-1.5 bg-blue-50 rounded-full">
                            ...
                            <span class="text-xs font-semibold text-blue-700">Akun PPK Aktif</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="w-full md:w-2/3 space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-xl p-6 sm:p-8 border border-gray-100">
                <div class="flex items-center gap-3 mb-6 border-b border-gray-50 pb-4">
                    ...
                    <h3 class="text-xl font-bold text-gray-900">Informasi Profil PPK</h3>
                </div>

                <form action="{{ route('ppk.akun.update') }}" method="POST" class="space-y-4">
                    @csrf
                    @method('PATCH')
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div class="space-y-1 opacity-60">
                            ...
                            <input type="text" value="{{ strtoupper($userRole) }}" disabled
            ...
            <div class="bg-white rounded-2xl shadow-xl p-6 sm:p-8 border border-gray-100">
                ...
                <form action="{{ route('ppk.akun.password') }}" method="POST" class="space-y-4">
                    @csrf
                    @method('PATCH')
                    <div class="space-y-1">
