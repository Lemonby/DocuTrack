    ...
    <section class="bg-white p-6 sm:p-10 lg:p-12 rounded-[2rem] shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden mb-8">
        ...
        <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-10 pb-6 border-b border-slate-100 gap-4">
            <div class="w-full lg:w-auto">
                ...
                <p class="text-slate-400 text-xs mt-1">Review & Persetujuan Usulan KAK oleh PPK</p>
                ...
                @if($kegiatan->posisi_id == 3)
                    <form action="{{ route('ppk.kegiatan.store', $id) }}" method="POST" class="space-y-6 w-full">
                        ...
                        <div class="flex flex-col sm:flex-row justify-between items-center pt-8 border-t border-slate-100 gap-4">
                            <div>
                                <a href="{{ route('ppk.kegiatan.index') }}" class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 bg-[#187CFC] hover:bg-blue-700 text-white rounded-2xl transition font-black text-sm shadow-lg shadow-blue-200 active:scale-95">
                                    <i class="fas fa-arrow-left"></i> Kembali
                                </a>
                            </div>
                            
                            <div class="flex flex-wrap items-center gap-3 w-full sm:w-auto justify-end">
                                <button type="submit" name="action" value="approve" class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 bg-[#187CFC] hover:bg-blue-700 text-white rounded-2xl transition font-black text-sm shadow-lg shadow-blue-200 active:scale-95">
