...
<main class="main-content font-poppins p-4 md:p-7 -mt-8 md:-mt-20 max-w-7xl mx-auto w-full">
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-gradient-to-r from-[#17A18A] via-[#006A9A] to-[#114177] rounded-2xl shadow-xl p-6 md:p-8 mb-6 text-white">
            <div class="flex flex-col sm:flex-row items-center sm:items-start gap-6">
                ...
                <div class="relative group flex-shrink-0">
                    ...
                    <form id="avatar-form" action="{{ url('/' . ($userRole ?? 'superadmin') . '/akun/update') }}" method="POST" enctype="multipart/form-data" class="absolute inset-0 opacity-0 cursor-pointer">
                        @csrf
                        @method('PATCH')
                ...
                <div class="text-center sm:text-left">
                    ...
                    <p class="text-white/80 mt-1 capitalize">{{ str_replace('_', ' ', $userRole ?? 'superadmin') }} &bull; DocuTrack PNJ</p>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden mb-6">
            ...
            <div class="p-6">
                <form action="{{ url('/' . ($userRole ?? 'superadmin') . '/akun/update') }}" method="POST">
                    @csrf
                    @method('PATCH')
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
            ...
            <div class="p-6">
                <form action="{{ url('/' . ($userRole ?? 'superadmin') . '/akun/password') }}" method="POST">
                    @csrf
                    @method('PATCH')
